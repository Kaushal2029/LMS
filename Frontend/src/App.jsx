...
const UserPage = lazy(() => import("./pages/app/user"));
const CityPage = lazy(() => import("./pages/app/city"));
const ReportPage = lazy(() => import("./pages/app/report"));
const ReportDetailsPage = lazy(() =>
  import("./pages/app/report/ReportDetailsPage")
);
const UserViewPage = lazy(() => import("./pages/app/user/UserViewPage"));
const UserEditPage = lazy(() => import("./pages/app/user/UserEditPage"));
const CityEditPage = lazy(() => import("./pages/app/city/CityEditPage"));
const PostPage = lazy(() => import("./pages/app/post"));
const AddUserPage = lazy(() => import("./pages/app/post/AddUser"));
const AddCity = lazy(() => import("./pages/app/city"));
const AddCityPage = lazy(() => import("./pages/app/cityadd/AddCityPage"));
    ...
    <main className="App  relative">
      <Routes>
        ...
        <Route path="/*" element={<Layout />}>
          ...
          <Route path="city/edit/:id" element={<CityEditPage />} />
          <Route path="report" element={<ReportPage />} />
          <Route path="report/:id" element={<ReportDetailsPage />} />
          <Route path="posts" element={<PostPage />} />
          <Route path="posts/add" element={<AddUserPage />} />
